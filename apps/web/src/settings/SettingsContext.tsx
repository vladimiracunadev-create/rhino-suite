...
const es: Dict = {
  ...
  signInSubtitle: "Tus documentos, desde cualquier equipo",
  signInFailed: "No se pudo iniciar sesión.",
  signInFoot: "Tus documentos son privados: solo tú los ves, salvo que los compartas.",
  email: "Correo",
  nameLabel: "Nombre",
  nameOptional: "Opcional",
  password: "Contraseña",
  passwordHint: "Al menos {n} caracteres. Cuanto más larga, mejor.",
  signOut: "Cerrar sesión",
  account: "Cuenta",
  share: "Compartir",
  shareTitle: "Compartir documento",
  shareWith: "Compartir con",
  sharePlaceholder: "correo de la persona",
  roleViewer: "Puede leer",
  roleEditor: "Puede editar",
  sharedWith: "Compartido con",
  notShared: "Todavía no lo has compartido con nadie.",
  removeAccess: "Quitar acceso",
  sharedByOther: "Compartido contigo",
  onlyOwnerShares: "Solo quien creó el documento puede compartirlo.",
...
const en: Dict = {
  ...
  signInSubtitle: "Your documents, from any device",
  signInFailed: "Could not sign in.",
  signInFoot: "Your documents are private: only you see them, unless you share them.",
  email: "Email",
  nameLabel: "Name",
  nameOptional: "Optional",
  password: "Password",
  passwordHint: "At least {n} characters. The longer, the better.",
  signOut: "Sign out",
  account: "Account",
  share: "Share",
  shareTitle: "Share document",
  shareWith: "Share with",
  sharePlaceholder: "person's email",
  roleViewer: "Can view",
  roleEditor: "Can edit",
  sharedWith: "Shared with",
  notShared: "You haven't shared it with anyone yet.",
  removeAccess: "Remove access",
  sharedByOther: "Shared with you",
  onlyOwnerShares: "Only whoever created the document can share it.",
  readOnly: "Read only",
};
